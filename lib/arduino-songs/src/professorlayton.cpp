...
static const int professorlayton_melody[] = {
...
const Song professorlayton_song = {
    "Professorlayton",
    professorlayton_melody,
    sizeof(professorlayton_melody) / sizeof(professorlayton_melody[0]) / 2,
    140
};
